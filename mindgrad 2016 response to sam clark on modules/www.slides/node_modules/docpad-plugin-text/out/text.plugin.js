...
(function() {
  ...
  module.exports = function(BasePlugin) {
    var TextPlugin;
    return TextPlugin = (function(superClass) {
      extend(TextPlugin, superClass);
      ...
      TextPlugin.prototype.populateText = function(opts, next) {
        var TaskGroup, balUtil, config, docpad, file, me, replaceElementCallback, source, templateData;
        me = this;
        docpad = this.docpad;
        ...
        replaceElementCallback = function(outerHTML, elementName, attributes, innerHTML, replaceElementCompleteCallback) {
          ...
          replaceElementTasks = new TaskGroup().done(function(err) {
