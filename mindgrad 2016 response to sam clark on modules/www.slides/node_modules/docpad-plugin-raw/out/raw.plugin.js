...
(function() {
  ...
  module.exports = function(BasePlugin) {
    var RawPlugin;
    return RawPlugin = (function(superClass) {
      extend(RawPlugin, superClass);

      function RawPlugin() {
        return RawPlugin.__super__.constructor.apply(this, arguments);
      }

      RawPlugin.prototype.name = 'raw';

      RawPlugin.prototype.writeAfter = function(opts, next) {
